                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <form action="{{ route('store.slider') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>Link</label>
                                                <input type="text" class="form-control" name="link" placeholder="Link (Jika Ada)">
                                            </div>
                                            <div class="form-group">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            @php
                                $nomor = 1;
                            @endphp
                            @forelse ($dataview->slider as $item)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".form-edit{{ $item->id_slider }}">
                                        <i class="mdi mdi-pencil"></i>
                                    </button>
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target=".form-hapus{{ $item->id_slider }}">
                                        <i class="mdi mdi-delete"></i>
                                    </button>
                                </td>
                            </tr>

                            <div class="modal fade form-edit{{ $item->id_slider }}" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="scard-box">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <form action="{{ route('update.slider', $item->id_slider) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="form-group">
                                                                <label>Link</label>
                                                                <input type="text" class="form-control" name="link" placeholder="Link (Jika Ada)" value="{{ $item->link }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Status Aktif</label>
                                                                <select class="form-control" name="status_aktif">
                            ...
                            <div class="modal fade form-hapus{{ $item->id_slider }}" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="scard-box">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <form action="{{ route('delete.slider', $item->id_slider) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="form-group text-center">
                                                                <img src="{{ asset($item->file_gambar) }}" class="img-fluid">
                                                            ...
                                                            <p>
                                                                <b>Apakah anda ingin menghapus slider ini?</b>
                                                            </p>

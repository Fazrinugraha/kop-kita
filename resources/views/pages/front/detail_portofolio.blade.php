...
<meta property="og:title" content="Portofolio | {{ $dataview->portofolio->nama_produk }}" />
<meta property="og:description" content="{{ strip_tags(getExcerpt($dataview->portofolio->deskripsi)) }}" />
<meta property="og:image" content="{{ asset($dataview->portofolio->file_gambar) }}" />
...
@section('content')
    ...
    <section class="section" style="padding-top: 40px;">
        <div class="container-fluid">
            ...
            <h3 class="mb-4">{!! $dataview->portofolio->nama_produk !!}</h3>

            <div class="row justify-content-start">
                <div class="col-lg-8">
                    
                    <p style="font-size: 14px;">
                        <i class="mdi mdi-calendar"></i> {{ tanggalIndonesia($dataview->portofolio->created_at, true) }}&nbsp;&nbsp;|&nbsp;&nbsp;<i class="mdi mdi-eye"></i> Sudah {{ number_format($dataview->portofolio->view) }}x Dibaca
                    </p>
                    <hr>
                    ...
                    <p>
                        ...
                        <a class="btn btn-sm btn-info" 
                           href="http://twitter.com/share?text={{ urlencode($dataview->portofolio->nama_produk) }}&url={{ urlencode(url()->current()) }}" 
                           target="_blank">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <td rowspan="4" class="text-center">
                                    <img src="{{ asset($dataview->portofolio->file_icon) }}" height="120">
                                </td>
                                <td>Bidang Jasa: {{ $dataview->portofolio->nama_jasa }}</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <strong>{!! $dataview->portofolio->nama_produk !!}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <a href="{{ $dataview->portofolio->link }}">{{ $dataview->portofolio->link }}</a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">Jenis: {{ $dataview->portofolio->kategori }}</td>
                            </tr>
                            <tr>
                                <td colspan="2">{{ $dataview->portofolio->deskripsi }}</td>
                            </tr>
                        </table>
                    </div>

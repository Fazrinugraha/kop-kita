...
<meta property="og:title" content="Pengabdian | {{ $dataview->pengabdian->nama_kegiatan }}" />
<meta property="og:description" content="{{ strip_tags(getExcerpt($dataview->pengabdian->keterangan)) }}" />
<meta property="og:image" content="{{ asset($dataview->pengabdian->file_gambar) }}" />
...
@section('content')
    ...
    <section class="section" style="padding-top: 40px;">
        <div class="container-fluid">
            ...
            <h3 class="mb-4">{{ $dataview->pengabdian->nama_kegiatan }}</h3>

            <div class="row justify-content-start">
                <div class="col-lg-8">
                    
                    <p style="font-size: 14px;">
                        <i class="mdi mdi-calendar"></i> {{ tanggalIndonesia($dataview->pengabdian->created_at, true) }}&nbsp;&nbsp;|&nbsp;&nbsp;<i class="mdi mdi-eye"></i> Sudah {{ number_format($dataview->pengabdian->view) }}x Dibaca
                    </p>
                    <hr>
                    ...
                    <p>
                        ...
                        <a class="btn btn-sm btn-info" 
                           href="http://twitter.com/share?text={{ urlencode($dataview->pengabdian->nama_kegiatan) }}&url={{ urlencode(url()->current()) }}" 
                           target="_blank">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <td class="text-center">
                                    <img src="{{ asset($dataview->pengabdian->file_gambar) }}" class="img-fluid">
                                </td>
                            </tr>
                            <tr>
                                <td><i class="mdi mdi-calendar-today font-16 mr-1 align-middle"></i> <small><b>{{ bulanIndonesia($dataview->pengabdian->bulan) }}</b></small>&nbsp;&nbsp;<i class="mdi mdi-map-marker-outline font-16 mr-1 align-middle"></i> <small>{{ $dataview->pengabdian->lokasi }}</small></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>{{ $dataview->pengabdian->nama_kegiatan }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td>{!! $dataview->pengabdian->deskripsi !!}</td>
                            </tr>
                        </table>
                    </div>
